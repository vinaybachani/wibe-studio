...
const About = () => {
    return (
        <Section id="fixed-target" className='about'>
            ...
            <Right>
                <img src={img1} alt="about us image1" />
                <img src={img2} data-scroll data-scroll-speed="5" className='small-img-1' alt="about us image2" />
                <img src={img3} data-scroll data-scroll-speed="-2" className='small-img-2' alt="about us image3" />
            </Right>
        </Section>
    )
}
