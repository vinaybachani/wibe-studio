        ...
        <Section>
            ...
            >
                <ul>
                    ...
                    <li>
                        <a href="http://google.com" target='_blank' rel='noreferrer'>review</a>
                    </li>
                </ul>
                <Bottom>
                    <span data-scroll data-scroll-speed="2" data-scroll-direction="horizontal">&copy; {new Date().getFullYear()}. All Rights Reserved.</span>
                    <span data-scroll data-scroll-speed="-2" data-scroll-direction="horizontal">Made with &hearts;</span>
                </Bottom>
            </FooterComponent>
        </Section>
    )
